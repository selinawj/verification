  ...
  if (!is.na(poster)){
    if (poster == "agent") {
      if (is.na(prepost[row,license_col])){
        prepost[row,16] = prepost[row,16] - 1.3 #missing license
...
#Conclusion: threshold 1.3 - scammer: 5/346 = 1.44%, please verify: 1037/1076 = 96.37%